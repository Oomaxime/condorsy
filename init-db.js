...
db.surveys.insertMany([
  ...
  },
  {
    ...
    description:
      "Sponte timidus defessus cotidie. Brevis aduro libero confido possimus eum coepi altus. Cariosus sunt derelinquo amet crur occaecati cura deleniti.",
    date: {
      create: "2024-07-14",
      start: "2024-12-14",
      end: "2025-03-05",
    ...
    choix: ["singing", "blowgun", "dredger", "valuable"],
    reponses: [
      {
        user_id: {
          $oid: "111f3772-912b-4c6d-b714-0d17ec606f67",
        },
        reponse: ["singing", "dredger", "valuable", "blowgun"],
      },
      {
        user_id: {
          $oid: "6ebb8495-2a7c-4725-a965-31ef9669697f",
        },
        reponse: ["blowgun", "singing", "dredger"],
      },
      {
        user_id: {
          $oid: "3378ac40-afc8-417e-b7b1-c521f842e2a8",
        },
        reponse: ["valuable", "singing"],
      },
      {
        user_id: {
          $oid: "90588e11-ac8e-49de-8b64-db5f9fb0cd48",
        },
        reponse: ["singing", "valuable", "blowgun"],
      },
      {
        user_id: {
          $oid: "fe885170-5f83-49e0-84d6-9363a456574a",
        },
        reponse: ["valuable", "singing", "dredger", "blowgun"],
      },
    ],
  },
  {
    ...
    description:
      "Tego decimus alii consuasor solus degenero ater spiritus uterque ex. Comparo decor abutor varietas aveho umquam. Aggredior texo vulariter defessus esse vinco tricesimus.",
    date: {
      create: "2024-10-01",
      start: "2025-01-30",
      end: "2025-07-05",
    ...
    choix: ["independence", "king", "cinder"],
    reponses: [],
  },
  {
    creator: {
    ...
    description:
      "Creber provident titulus via speciosus universe casus absque. Theologus aspernatur bellicus ultra attero cerno adfero. Usus caritas tergeo.",
    date: {
      create: "2024-07-07",
      start: "2025-01-04",
      end: "2025-06-10",
    ...
    choix: ["plugin", "tomography", "eyebrow", "quit", "bathhouse"],
    reponses: [
      {
        user_id: {
          $oid: "ac9f0f16-5fce-495a-91f1-d6e91b3f1e68",
        },
        reponse: ["tomography", "bathhouse", "plugin", "eyebrow", "quit"],
      },
      {
        user_id: {
          $oid: "cd5bc8d3-ba8c-460b-96b4-e6fd70909c89",
